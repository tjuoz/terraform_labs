# Terraform lab3 example

This Terraform code creates infrastructure based on lab requirements.
...
* The code was written for:
  * Terraform v1.3.3 or later

* It uses the Terraform AzureRM Provider v4.8.0.
